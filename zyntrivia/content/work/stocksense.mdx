...
<ArchDiagram
  tiers={[
    [{ label: "Client", sub: "Next.js App Router · Server Components" }],
    [
      { label: "Reads", sub: "Materialized current-stock view" },
      { label: "Mutations", sub: "Server Actions" },
    ],
    [{ label: "Data", sub: "PostgreSQL · append-only StockMovement ledger", accent: true }],
  ]}
/>
